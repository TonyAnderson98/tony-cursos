            ...
            <div className="min-h-screen flex flex-col gap-8 items-center justify-center p-4">
                <div className="w-full max-w-md">
                    <div className="text-center flex flex-col gap-2 mb-8">
                        ...
                        <h2 className="text-3xl font-extrabold text-white">Bem vindo à nossa plataforma!</h2>
                    ...
                    <div className="bg-gray-800/50 rounded-2xl p-8 shadow-xl border border-gray-700/50 ">
                        <form action="#" method="post" className="flex flex-col gap-4">
                            <div>
                                <label htmlFor="name" className="block text-sm text-gray-300 font-medium">Nome</label>
                                <Input type={"text"} id={"name"} name={"name"} placeholder={"Seu nome"} />
                            </div>
                            <div>
                                <label htmlFor="email" className="block text-sm text-gray-300 font-medium">Email</label>
                                <Input type={"email"} id={"email"} placeholder={"seu@mail.com"} name={"email"} required />
                            </div>
                            <div>
                                <label htmlFor="password" className="block text-sm text-gray-300 font-medium">Senha</label>
                                <Input type={"password"} id={"password"} placeholder={"* * * * * *"} name={"password"} required />
                            </div>

                            <div>
                                <label htmlFor="password_confirm" className="block text-sm text-gray-300 font-medium">Confirme a sua senha</label>
                                <Input type={"password"} id={"password_confirm"} placeholder={"* * * * * *"} name={"password_confirm"} required />
                            </div>
                        ...
                        <div className="mt-6">
                            ...
                            <div className="mt-6">
                                ...
                                >
                                    ...
                                    <span className="ml-4">Cadastrar com Google</span>
                                </button>
                            </div>
                        </div>
                    ...
                    <p className="mt-8 text-center text-sm text-gray-400">
                        Já possui uma conta?{' '}
                        <a href="/auth/login" className="font-medium text-indigo-400 hover:text-indigo-300 transition-colors duration-200">
                            faça login
                        </a>
                    </p>
                </div>
