...
export function CourseList() {
    ...
    if (loading) return (
        <div className="flex justify-center items-center h-64">
            <div className="animate-pulse text-xl text-slate-300">Carregando cursos...</div>
        </div>
    );
                ...
                {courses.map((course) => (
                    ...
                    >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black to-black/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-4">
                            ...
                            <p className="text-sm text-slate-200 line-clamp-3 mb-3">{course.course_description}</p>
